...
profile_data = { 'Repo ID': 'CTFd', 'Status': 'ACTIVE', 'Security Risk': True, 'EOL Risk': False, 'Repo Size (MB)': 25, 'File Count': 929, 'Lines of Code': 106417, 'Contributors': 149, 'Repo Age (Years)': 10, 'Health Scores': { 'Code Quality': 80, 'Security': 40, 'Modernization': 60, }, 'Vulnerabilities': [ {'CVE': 'GHSA-vc8w-jr9v-vj7f', 'Severity': 'Critical'}, ], 'Dependencies': []  # Populate if available }
