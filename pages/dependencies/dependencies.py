...
from pages.dependencies.dependencies_kpi_row import dependencies_kpi_row
...
header_with_button = dbc.Row(
    [
        dbc.Col(html.H2("Dependencies"), width="auto", className="d-flex align-items-center"),
        dbc.Col(
            html.Div(
        ...
        dbc.Col(dependencies_kpi_row(), width="auto"),
    ],
