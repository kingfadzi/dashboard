    ...
    def query_data(condition_string, param_dict):
        ...
        query = f"""
            ...
            SELECT
                ...
                (SELECT COUNT(*) FROM massive_lang_groups WHERE lang_group = 'code') AS massive_other_programming,
                (SELECT COUNT(*) FROM massive_lang_groups WHERE lang_group = 'markup_or_data') AS massive_markup_or_data,
                (SELECT COUNT(*) FROM massive_lang_groups WHERE lang_group = 'no_language') AS massive_no_language,
