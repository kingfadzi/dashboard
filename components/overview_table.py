...
def render_overview_table(dataframe):
    table_data = viz_table_data(dataframe)
    ...
    return dbc.Card(
        [
            dbc.CardHeader(html.B("Repository Table View", className="text-center")),
            dbc.CardBody(
