...
def kpi_layout():
    ...
    return dbc.Row(
        [
            ...
            make_col(make_card("Old Repos",        "kpi-old-repos",      "kpi-old-repos-subtext",      ">1yr")),
            ...
            make_col(make_card("Dockerfiles",      "kpi-dockerfiles",    "kpi-dockerfiles-subtext",    "Dockerfile")),
            make_col(make_card("Docker Compose",   "kpi-docker-compose", "kpi-docker-compose-subtext", "docker-compose.yml")),
            make_col(make_card("Helm Charts",      "kpi-helm-charts",    "kpi-helm-charts-subtext",    "Helm")),
